(function ($) {
    ...
    table = $('#regions_table').DataTable({
        ...
        fixedHeader: true,
        "ajax": {
            url: url("admin/region/get_regions")
        },
        fixedHeader: true,
        "columns": [
            ...
            { data: "government.name", orderable: false, sortable: false },
    ...
    //delete regions
    $(document).on('click', '.delete_regions', function (e) {
        e.preventDefault();
        var el = $(this);
        swal({
            title: trans("Are you sure to delete regions ?"),
            type: "warning",

(function ($) {
    ...
    //governments datatable
    table = $('#governments_table').DataTable({
        ...
        fixedHeader: true,
        "ajax": {
            url: url("admin/government/get_governments")
        },
        fixedHeader: true,
        "columns": [
    ...
    //active
    $('#governments').addClass('active');


    $('#governments_form').validate({
        rules: {
            name: {
                required: true
            },
    ...
    //delete governments
    $(document).on('click', '.delete_governments', function (e) {
        e.preventDefault();
        var el = $(this);
        swal({
            title: trans("Are you sure to delete governments ?"),
            type: "warning",

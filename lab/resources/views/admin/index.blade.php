...
@section('content')
  ...
  @canAny(['view_group' , 'view_patient' , 'view_medical_report'])
        ...
        <div class="card card-default card-outline">
          <div class="card-body">
            <div class="row">
                ...
                <!-- General statistics -->
                <div class="col-lg-4 col-sm-12 col-xs-12 mt-4 mb-4 custom-primary-box">
                  <div class="row">
                    <div class="col-3 col-sm-4 col-xs-4">
                      <span class="icon">
                        <span class="text-center">
                ...
                <!-- tests statistics -->
                <div class="col-lg-4 col-sm-12 col-xs-12 mt-4 mb-4 custom-info-box">
                  <div class="row">
                    <div class="col-3 col-sm-4 col-xs-4">
                      <span class="text-center icon">
                        <i class="fa fa-list"></i>

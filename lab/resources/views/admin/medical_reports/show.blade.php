...
<form method="POST" action="{{ route('admin.medical_reports.pdf', $group['id']) }}" id="print_form">
    ...
    <div class="row mb-3">
        ...
        <div class="col-lg-6">
            ...
            <button type="button" data-url="{{ route('admin.medical_report.include.history') }}" class="btn btn-info include_history float-right d-inline mr-2">
                <i class="fas fa-check-square"></i>
                {{ __('Include History') }}
            </button>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <div style="display: inline-block;">
                                ...
                                <input class="form-control" type="radio" name="report_design" checked id="d1" value="1">
                            </div>
                            <div style="display: inline-block;">
                                ...
                                <input class="form-control" type="radio" name="report_design" id="d2" value="2">
                            </div>
